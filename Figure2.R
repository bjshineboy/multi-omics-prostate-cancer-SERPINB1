...
setwd("/work/singleCell/prostate_singecell_20250627/GSE_Raw/sci/SERPNB1_sci_20250829/code/2/Figure2_Data")
...
surv_file <- "/work/singleCell/prostate_singecell_20250627/GSE_Raw/DOWN_FROM_LJY/survival_PRAD_survival.txt"
...
#  
clinical_palette <- c("#1B9E77", "#D95F02")  
